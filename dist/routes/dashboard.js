...
import { loadConfig, getGatewayRunning, setGatewayRunning, getActiveApiKey, saveConfigFile, } from '../utils/config.js';
...
export async function dashboardRoutes(fastify) {
    ...
    fastify.post('/api/gateway/toggle', async (req, reply) => {
        const body = req.body || {};
    ...
    fastify.post('/api/config/permission-mode', async (req, reply) => {
