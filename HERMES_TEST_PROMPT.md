...
Report: chunk count, any chunk missing fields, any `<think>` text leaking into `content`.
...
correct behavior. FAIL if: reasoning text appears inside `content`, or `<think>` tags appear
